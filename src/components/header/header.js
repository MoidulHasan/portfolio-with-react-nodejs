            ...
            <div className={`d-flex align-items-center justify-content-between pe-5`}>
                ...
                <div className={`text-light  me-3`}>
                    <NavLink to={'#services'} className={`text-decoration-none`}>
                        <h6 className={`text-light text-uppercase`}>02.<span className='text-info'> Skills </span></h6>
                    </NavLink>
                </div>
                <div className={`text-light  me-3`}>
                    <NavLink to={'#projects'} className={`text-decoration-none`}>
                        <h6 className={`text-light text-uppercase`}>03.<span className='text-info'> Projects </span></h6>
                    </NavLink>
                </div>
                <div className={`text-light  me-3`}>
                    <NavLink to={'#contact'} className={`text-decoration-none`}>
                        <h6 className={`text-light text-uppercase`}>04.<span className='text-info'> Contact </span></h6>
                    </NavLink>
                </div>
            </div>
        </div>
